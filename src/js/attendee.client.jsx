...
ReactDOM.render(
  <Router history={AppHistory}>
    <Route path="/" component={Layout}>
      <IndexRoute apiBaseURL={AjaxService.getUrl()} component={Home} onEnter={requireAuth}></IndexRoute>
      ...
      <Route path="info" apiBaseURL={AjaxService.getUrl()} component={Info} onEnter={requireAuth}></Route>
