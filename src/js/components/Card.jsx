  ...
  render() {
    ...
    switch (type) {
      ...
      case 'download':
        ...
        break;
      case 'social':
        const facebook = this.props.facebook || null;
        const twitter = this.props.twitter || null;
...
const ContactCard = React.createClass({
  render() {
...
const LocationCard = React.createClass({
  render() {
    const locationNodes = this.props.data.map(confLocation => (
...
const DownloadCard = React.createClass({
  render() {
    return (
      <BetterCard>
        <CardTitle
...
const SocialCard = React.createClass({
  render() {
    return (
      <BetterCard>
        <CardTitle
...
const SurveyCard = React.createClass({
  render() {
    return (
      <BetterCard>
        <CardTitle
